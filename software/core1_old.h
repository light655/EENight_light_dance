	...
	*/
    ...
    while(true) {
        ...
        for(int i = 0; i < 250; i++) {
            ...
            I_target[0] = current_min[0] + (current_max[0] - current_min[0]) * ratio;
            I_target[1] = current_min[1] + (current_max[1] - current_min[1]) * ratio;
            I_target[2] = current_min[2] + (current_max[2] - current_min[2]) * ratio;
            I_target[3] = current_min[3] + (current_max[3] - current_min[3]) * ratio;
            busy_wait_us(11500);
